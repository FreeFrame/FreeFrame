...
protected:
	...
	SPete_TimeBlur_Data m_InstanceData;
	SPete_TimeBlur_Settings m_Settings;
...
CTimeBlurDfx::CTimeBlurDfx()
{
	...
	Pete_TimeBlur_GetParameters(&m_pParameters,&m_nParameterCount);
...
CTimeBlurDfx::~CTimeBlurDfx()
{
	...
	Pete_TimeBlur_DeInit(&m_InstanceData);
...
BOOL	CTimeBlurDfx::Initialize()
{
	...
	Pete_TimeBlur_Init(&m_InstanceData,m_nXRes,m_nYRes);
...
BOOL	CTimeBlurDfx::Render(CScreen **ppInput, CScreen *pOutput)
{
	...
	Pete_TimeBlur_Render(&m_InstanceData,&m_Settings,pInputMem,pOutputMem);
...
BOOL CTimeBlurDfx::ConfirmRenderSource(int i)
{
	return TRUE;
}

DWORD CTimeBlurDfx::GetInputState()
{
	return 0xffffffff;
}
